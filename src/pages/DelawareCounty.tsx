...
const DelawareCounty = () => {
  const schema = createCountyPageSchema(
    "Delaware County",
    "https://www.phillytaxappeals.com/delaware-county-property-tax-appeal"
  );

  return (
    <div className="min-h-screen bg-background">
      <PageSEO
        title="Delaware County Property Tax Appeals | Expert Tax Reduction Services"
        description="Professional Delaware County property tax appeal services. Reduce your property tax burden with our local expertise and no upfront costs. Free assessment evaluation."
        canonicalPath="/delaware-county-property-tax-appeal"
        schema={schema}
      />
