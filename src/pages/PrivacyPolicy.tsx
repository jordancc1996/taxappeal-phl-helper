        ...
        <div className="space-y-12 text-foreground">
          ...
          <section className="space-y-4">
            ...
            <div className="text-base md:text-lg font-body leading-relaxed">
              <p>Email: <a href="mailto:info@phillytaxappeals.com" className="hover:opacity-60 transition-opacity">info@phillytaxappeals.com</a></p>
              <p>Phone: <a href="tel:+12155551234" className="hover:opacity-60 transition-opacity">(215) 555-1234</a></p>
