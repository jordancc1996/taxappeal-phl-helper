      ...
      <div className="max-w-[1600px] mx-auto">
        <div className="grid md:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3 text-lg font-body text-foreground">
              <li><a href="mailto:info@phillytaxappeals.com" className="hover:opacity-60 transition-opacity">info@phillytaxappeals.com</a></li>
              <li><a href="tel:+12155551234" className="hover:opacity-60 transition-opacity">(215) 555-1234</a></li>
            </ul>
          </div>
        </div>
